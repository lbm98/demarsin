...
<template>
  <CountryView>
    ...
    <template #images>
      ...
      <ImageWrapper country="kretasantorini" image-name="boom"/>
      <ImageWrapper country="kretasantorini" image-name="gramvousa"/>
      <ImageWrapper country="kretasantorini" image-name="iraklion"/>
      <ImageWrapper country="kretasantorini" image-name="kerk"/>
      <ImageWrapper country="kretasantorini" image-name="knossos"/>
      <ImageWrapper country="kretasantorini" image-name="kraterrand"/>
      <ImageWrapper country="kretasantorini" image-name="kreta"/>
      <ImageWrapper country="kretasantorini" image-name="matala"/>
      <ImageWrapper country="kretasantorini" image-name="monnik"/>
      <ImageWrapper country="kretasantorini" image-name="rhodopou"/>
      <ImageWrapper country="kretasantorini" image-name="vai"/>
    </template>
