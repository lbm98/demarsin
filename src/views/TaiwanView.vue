...
<template>
  <CountryView>
    ...
    <template #images>
      ...
      <ImageWrapper country="taiwan" image-name="hualien"/>
      <ImageWrapper country="taiwan" image-name="kaishek"/>
      <ImageWrapper country="taiwan" image-name="martyrs"/>
      <ImageWrapper country="taiwan" image-name="museum"/>
      <ImageWrapper country="taiwan" image-name="shrmen"/>
      <ImageWrapper country="taiwan" image-name="taiwan"/>
      <ImageWrapper country="taiwan" image-name="tapei"/>
