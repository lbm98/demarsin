...
<template>
  <CountryView>
    ...
    <template #images>
      ...
      <ImageWrapper country="nieuwzeeland" image-name="boulders"/>
      <ImageWrapper country="nieuwzeeland" image-name="kauriboom"/>
      <ImageWrapper country="nieuwzeeland" image-name="kidnappers"/>
      <ImageWrapper country="nieuwzeeland" image-name="maorikunst"/>
      <ImageWrapper country="nieuwzeeland" image-name="matheson"/>
      <ImageWrapper country="nieuwzeeland" image-name="milford"/>
      <ImageWrapper country="nieuwzeeland" image-name="queenstown"/>
      <ImageWrapper country="nieuwzeeland" image-name="tapu"/>
      <ImageWrapper country="nieuwzeeland" image-name="taranaki"/>
      <ImageWrapper country="nieuwzeeland" image-name="tasman"/>
    </template>
